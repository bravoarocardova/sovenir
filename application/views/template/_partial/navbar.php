	...
	<div class="container">
		...
		<div class="collapse navbar-collapse justify-content-between" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a class="nav-link <?= $this->uri->segment(1) == '' ? 'active' : '' ?>" href="<?= base_url() ?>"><i
						class="fas fa-home"></i> Home</a>
				<?php if(!empty($this->session->userdata('pelanggan'))): ?>
				<a class="nav-link <?= $this->uri->segment(1) == 'keranjang' ? 'active' : '' ?>"
					href="<?= base_url('keranjang') ?>"><i class="fas fa-shopping-cart"></i> Keranjang</a>
				<a class="nav-link <?= $this->uri->segment(1) == 'riwayat' ? 'active' : '' ?>"
					href="<?= base_url('riwayat') ?>"><i class="fas fa-book"></i> Riwayat Belanja</a>
