...
class Laporan extends CI_Controller {
    ...
    public function cetak()
    {
        ...
        $pdf->Cell(0, 5, 'HD Elektronik', '0', '1', 'C', false);
        $pdf->Ln(5);
        $pdf->Ln(4);
        ...
        $pdf->Cell(8, 6, 'No', 1, 0, 'L');
        $pdf->Cell(20, 6, 'Pelanggan', 1, 0, 'L');
        $pdf->Cell(45, 6, 'Tanggal', 1, 0, 'L');
        $pdf->Cell(22, 6, 'Subtotal', 1, 0, 'L');
        $pdf->Cell(45, 6, 'Status', 1, 0, 'L');
        ...
        foreach ($semuadata as $ambil) {
            ...
            $pdf->Cell(20, 4, $ambil->nama_pelanggan, 1, 0, 'C');
            $pdf->Cell(45, 4, $ambil->tanggal_pembelian . ", " . date("d M Y", strtotime($ambil->tanggal_pembelian)), 1, 0, 'L');
        ...
        $pdf->ln(4);
        $pdf->Cell(162, 4, "Pemilik Toko  Luis Suryani . ", 0, 0, 'R');
